...
function ModalContent({ onButtonClick }: { onButtonClick: () => void }) {
  ...
  return (
    <div style={{
      ...
      <p style={labelStyle}>Choose a plan</p>
      <Select
        styles={selectStyles}
        isSearchable={false}
      ...
      />
      <p style={labelStyle}>Enter initial investment</p>
      <div
      ...
      <p style={labelStyle}>Days to grow</p>
      ...
      >
        <p style={{ ...labelStyle, marginRight: '30px', marginBottom: 0, flexShrink: 0 }}>Your profit:</p>
